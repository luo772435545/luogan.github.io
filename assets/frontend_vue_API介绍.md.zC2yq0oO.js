import{_ as s,c as a,o as n,U as p}from"./chunks/framework.Lp4q01XK.js";const g=JSON.parse('{"title":"API 介绍","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/vue/API介绍.md","filePath":"frontend/vue/API介绍.md"}'),e={name:"frontend/vue/API介绍.md"},i=p(`<h1 id="api-介绍" tabindex="-1">API 介绍 <a class="header-anchor" href="#api-介绍" aria-label="Permalink to &quot;API 介绍&quot;">​</a></h1><h2 id="effectscope" tabindex="-1">effectScope <a class="header-anchor" href="#effectscope" aria-label="Permalink to &quot;effectScope&quot;">​</a></h2><p>实例EffectScope可以收集在同步函数中运行的效果，以便稍后可以将这些效果一起处理。</p><p>比如下面这个例子,只在小于100的时候进行监听响应</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>&lt;script&gt;</span></span>
